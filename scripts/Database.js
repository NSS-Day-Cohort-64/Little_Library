...
const Database = {
    books: [
        ...
        { id: 12, title: "The Adventures of Huckleberry Finn", pages: 366, authorId: 9 },
        ...
        { id: 20, title: "The Adventures of Sherlock Holmes", pages: 307, authorId: 15 },
        { id: 21, title: "The Hound of the Baskervilles", pages: 190, authorId: 15 },
    ...
    children: [
        { id: 1, name: "Alice", libraryCard: "ALICE123" },
        { id: 2, name: "Bob", libraryCard: "BOB456" },
        { id: 3, name: "Charlie", libraryCard: "CHARLIE789" },
        { id: 4, name: "David", libraryCard: "DAVID012" },
        { id: 5, name: "Eve", libraryCard: "EVE345" }
    ],
    bookLogs: [
        { id: 1, checkoutDate: "2023-05-10", isReturned: false, childId: 1, bookId: 3 },
        { id: 2, checkoutDate: "2023-05-09", isReturned: true, childId: 2, bookId: 5 },
        { id: 3, checkoutDate: "2023-04-08", isReturned: false, childId: 3, bookId: 1 },
        { id: 4, checkoutDate: "2023-05-07", isReturned: true, childId: 4, bookId: 2 },
        { id: 5, checkoutDate: "2023-05-06", isReturned: false, childId: 5, bookId: 4 },
